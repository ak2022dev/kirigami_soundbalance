...
Looking-up properties of TextField... Seems it will need a separate label. Adding... Now added two text fields. Will commit, then try adding an additional button and figure out the logic for that.
